import{d as m,r as d,c as r,a as t,w as o,v as n,u as a,o as c,U as u}from"./index-0dc6695d.js";const p={class:"mdui-textfield mdui-textfield-not-empty"},v=t("label",{class:"mdui-textfield-label"},"转义前",-1),f={class:"mdui-textfield mdui-textfield-not-empty"},x=t("label",{class:"mdui-textfield-label"},"转义后",-1),w=m({__name:"LockTextCom",setup(b){const i=d(`[
    {
