import{d as m,r as d,c as r,a as t,w as o,v as n,u as a,o as c,S as u}from"./index-654617da.js";const p={class:"mdui-textfield mdui-textfield-not-empty"},v=t("label",{class:"mdui-textfield-label"},"转义前",-1),f={class:"mdui-textfield mdui-textfield-not-empty"},x=t("label",{class:"mdui-textfield-label"},"转义后",-1),w=m({__name:"LockTextCom",setup(b){const i=d(`[
    {
